...
let AnalyticsService = class AnalyticsService {
    ...
    async createBasicAnalytics(createAnalyticsYoutubeInput, queryRunner) {
        const createdAnalyticsYoutube = await this.analyticsYoutubeRepository.createAndSave(createAnalyticsYoutubeInput, queryRunner);
        return createdAnalyticsYoutube;
    }
    async getBasicAnalyticsByUserId(userId, queryRunner) {
        const analyticsYoutube = await this.analyticsYoutubeRepository.findByUserId(userId, queryRunner);
        return analyticsYoutube;
    }
    async getBasicAnalyticsByIntegrationId(integrationId, queryRunner) {

...
let NetworkService = class NetworkService {
    ...
    async getByUserId(userId, filter, queryRunner) {
        const networks = await this.networkRepository.findByUserId(userId, filter, queryRunner);
        return networks;
    }
    async deleteNetwork(id, queryRunner) {
        const queryResult = await this.networkRepository.deleteNetwork(id, queryRunner);
        return queryResult;
    }
};
